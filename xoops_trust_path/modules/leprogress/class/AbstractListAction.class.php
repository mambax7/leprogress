...
/**
 * Leprogress_AbstractListAction
**/
abstract class Leprogress_AbstractListAction extends Leprogress_AbstractAction
{
    public /*** XoopsSimpleObject[] ***/ $mObjects = null;

    public /*** Leprogress_AbstractFilterForm ***/ $mFilter = null;
    ...
    **/
     ...
     * @param   void
     * 
     * @return  &LeprogressAbstractFilterForm
    **/
